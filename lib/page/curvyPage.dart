...
class CurvyPage extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = paint.color = Color.fromRGBO(0, 21, 64, 0.2);
    ...
    paint.color = paint.color = Color.fromRGBO(0, 21, 64, 0.5);
    canvas.drawPath(path, paint);
    ...
    paint.color = Color.fromRGBO(0, 21, 64, 1);
    canvas.drawPath(path, paint);
  }

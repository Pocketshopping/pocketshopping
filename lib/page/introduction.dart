...
class Introduction extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    final first = PageViewModel(
      ...
      footer: Text("Fleepage LLC",style: TextStyle(color: Colors.white),),
    );
    final second = PageViewModel(
        titleWidget: Text("Merchant Location",style: TextStyle(color: PRIMARYCOLOR),),
        bodyWidget: Text("Get directions to Restuarant, Bars, Malls etc. within "
            "a defined radius. Pocketshopping also delivers realtime update on merchant closer to you"
          ,style: TextStyle(color: PRIMARYCOLOR),),
        image: Center(
          child: Image.asset('assets/images/locator.gif',
    ...
    final third = PageViewModel(
        titleWidget: Text("Use As Menu",style: TextStyle(color: PRIMARYCOLOR),),
        bodyWidget: Text("You can use pocketshopping as menu in restuarant for placing "
            " order",style: TextStyle(color: PRIMARYCOLOR),),
        image: Center(
          child: Image.asset('assets/images/menu.gif',
            height: MediaQuery.of(context).size.height*0.4,
          ),
        ),
        decoration: PageDecoration(
    ...
    final fourth = PageViewModel(
        titleWidget: Text("Welcome to PocketShopping",style: TextStyle(color: PRIMARYCOLOR),),
        bodyWidget: Text("we promise to give you the best",style: TextStyle(color: PRIMARYCOLOR),),
        image: Center(
          child: Image.asset('assets/images/online_store_.png',
            height: MediaQuery.of(context).size.height*0.4,
          ),
        ),
        decoration: PageDecoration(

...
class _BusinessPageState extends State<BusinessPage> {
  ...
  Widget build(BuildContext context) {
    ...
    title:Text("My Business",style: TextStyle(color: PRIMARYCOLOR),),
                      ...
                      child:Column(
                            ...
                            children: <Widget>[
                              Center(
                                ...
                                child: Text("You are currently registered as a user you can change to a business account by registering your businsess on pocketshopping",style: TextStyle(),),
                              )),
                              Center(child:Container(
                                ...
                                child: FlatButton(
                                  ...
                                  color: PRIMARYCOLOR,
                                  child: Text("Create A business",style: TextStyle(color: Colors.white),),
                                ),
                              )),

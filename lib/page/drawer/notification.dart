  ...
  return Container(
      ...
      Column(
        ...
        children: <Widget>[
          ...
          Center(child:Text(doc.data['notificationBody'],style: TextStyle(fontSize: 18),)),
          SizedBox(height: 10,),
          Row(
            children: <Widget>[
              Expanded(
                child: Text(format.format(DateTime.parse(doc.data['notificationCreatedAt'].toDate().toString()))),
              )
            ],
          ),
          SizedBox(height: 10,),
          ...
          Column(
            ...
            mainAxisAlignment: MainAxisAlignment.center,
            children: <Widget>[
          Center(child:Icon(Icons.thumb_up,
            size: MediaQuery.of(context).size.width*0.2,
            color: Colors.greenAccent,
          )),
            Center(child:
            Text("Congratulations! You are now a staff of ${
                doc.data['notificationBody'].toString().split('at')[1].split('do')[0]
            }")),
            Center(child:
            FlatButton(
              onPressed: (){
                psProvider.of(context).value['notifications'] = null;
                Navigator.push(
                  context,
                  MaterialPageRoute(
          ...
          Column(
            children: <Widget>[
              ...
              Center(child:
              Text("Error processing request check your connection and try again",
              ...
              Center(
                child: FlatButton(
                  ...
                  child: Text('Try Again',style: TextStyle(color: Colors.black54),),
                ),
              )
            ],
          )
      ...
      :Center(child:Column(
        children: <Widget>[
          ...
          Text('Processing Request please wait!',style:
  ...
  Widget notificationWidget() {
    if(psProvider.of(context).value['notifications'] == null){
      return FutureBuilder(
              ...
              child: Center(child:
                Column(
                  children: <Widget>[
                    ...
                    Text('No Pending Rquest',style: TextStyle(color: Colors.black54,
                    fontSize: 16),),
                  ],
                )
              )
        ...
        future: NotificationDataModel(uid:psProvider.of(context).value['uid'],nCleared: false).getAll(),
      );
    }
    else{
      return ListView.builder(
      ...
      child: Scaffold(
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title: Text(" Request(s)",style: TextStyle(color: PRIMARYCOLOR),),

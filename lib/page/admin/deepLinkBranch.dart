...
class _DeepLinkBranchState extends State<DeepLinkBranch> {
  ...
  void initState() {
    ...
    _uniquController.addListener(() {
      if (RegExp(r'^[a-zA-Z\s]+$').hasMatch(_uniquController.text)) {
        MerchantDataModel().branchNameUnique(
            data['merchantID'], _uniquController.text).then((value) => {
          isUnique = value,
          print(value),
          setState((){})
        });
  ...
  Widget build(BuildContext context) {
    ...
    final name = TextFormField(
      ...
      decoration: InputDecoration(
        labelText:(data !=null ?"Name: Note.you can not edit business name":"Business Name "),
    ...
    final category =  DropdownButtonFormField<String>(
      ...
      onChanged: data != null ?null:(value) {
        setState(() {
          bcategory = value;
        });
      },
          ...
          if (_formKey.currentState.validate()) {
            ...
            if(croppedFile != null)
            {
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          BusinessSetUpSecondPage(data:mdata,
                            fieldData: data,backFlag: 'single')));
            }
            else if(data != null){
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) =>BusinessSetUpSecondPage(data:mdata,fieldData: data,backFlag: 'single')));
            }
            else{
                    ...
                    new FlatButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) =>BusinessSetUpSecondPage(data:mdata,backFlag: 'single',)));
                      },
                      child: new Text('Yes'),
                    ),
                  ],
                      ...
                      slivers: <Widget>[ SliverList(
                          delegate: SliverChildListDelegate(
                            [
                              ...
                              psCard(
                                color: widget.color,
                                title: data != null ? "New Branch for " +
                                        ...
                                        Scaffold(
                                              ...
                                              appBar: PreferredSize(
                                                ...
                                                child: AppBar(
                                                  ...
                                                  backgroundColor: Colors.white,
                                                  title: Text(
                                                    "Branch Setup", style: TextStyle(color: PRIMARYCOLOR),),
                                                      ...
                                                      children: <Widget>[
                                                        ...
                                                        Container(
                                                          ...
                                                          padding: EdgeInsets.all(MediaQuery
                                                              ...
                                                              .size
                                                              .width * 0.02),
                                                          child: Text("Link has Expired! request a new link",
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  padding: EdgeInsets.all(MediaQuery
                      ...
                      .size
                      .width * 0.02),
                  child: Text("You can not create a branch because ${
                      psProvider.of(context).value['user']['role']=='admin'?'you own a business '
                          :'you are a staff'
                  }",
                    style: TextStyle(fontSize: 16),),
                ),

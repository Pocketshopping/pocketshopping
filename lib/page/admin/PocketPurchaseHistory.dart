...
class PocketPurchaseHistory extends StatefulWidget{
  ...
  @override
  _PocketPurchaseHistoryState createState() => new _PocketPurchaseHistoryState();
}
          ...
          builder: (context, model, child) => ListView.builder(
            ...
            itemBuilder: (context, index) => AwareListItem(
              ...
              child: ListItem(
                ...
                template: model.items[0] != SearchEmptyIndicatorTitle?PocketUnitHistoryIndicatorTitle:SearchEmptyIndicatorTitle,
                callback: (value){
                  detail(value);
                  return value ;
                },
                ...
                children: <Widget>[
                  Expanded(
                    child: FlatButton(
                      ...
                      onPressed: (){},
                      child: Text("Print Reciept",style: TextStyle(color: Colors.black54),),
                    ),
                  ),

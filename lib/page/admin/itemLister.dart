...
class ItemLister extends StatefulWidget {
  ...
  ItemLister({
    ...
    this.coverUrl='https://scontent-los2-1.xx.fbcdn.net/v/t1.0-9/13015366_962282610522031_7032913772865906850_n.jpg?_nc_cat=110&_nc_sid=dd9801&_nc_ohc=2tFLxKELYhUAX9UaXox&_nc_ht=scontent-los2-1.xx&oh=f4372b89baf627b42395be5d593f81ca&oe=5EA6150F',
    this.themeColor,});
...
void ColorReset(){
  ...
  itemColor = List<Color>.generate(items.length, (int index) {return Colors.white70;});
    setState(() { });
}

  void LoadColor(int length){

    itemColor.addAll( List<Color>.generate(length, (int index) {return Colors.grey.shade200;}));
    setState(() { });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SliverList(
        ...
        Container(
          ...
          Column(
              ...
              children: !widget.manage?ListItem():widget.item(1) //orders !=null?orders:<Widget>[]
          ),
          ]
        )
      ...
      floatingActionButton: widget.fabActionButton?FloatingActionButton(
        onPressed: (){
          showModalBottomSheet(
              context: context,
            ...
            child:
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Center(child: Text('Filter By',style: TextStyle(fontSize: 20),),),

...
class _ManageProductState extends State<ManageProduct> {
  ...
  Widget _appBarTitle = new Text( 'Manage Product',style: TextStyle(color: PRIMARYCOLOR), );
  ViewModel vmodel;
  ...
  setState(() {
    if (this._searchIcon.icon == Icons.search) {
      ...
      this._appBarTitle =  Text(" Manage Product",style: TextStyle(color: PRIMARYCOLOR),);
                  ...
                  builder: (context, model, child) => ListView.builder(
                    ...
                    itemBuilder: (context, index) => AwareListItem(
                      ...
                      child: ListItem(
                        ...
                        template: model.items[0] != SearchEmptyIndicatorTitle?ProductIndicatorTitle:SearchEmptyIndicatorTitle,
                        callback: (value){
                          detail(value);
                          return value ;
                        },

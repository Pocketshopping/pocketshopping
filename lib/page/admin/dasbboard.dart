          ...
          Scaffold(
            appBar: PreferredSize(
              ...
              child: AppBar(
                ...
                title:Text(psProvider.of(context).value['user']['businessName']??"Pocketshopping",style: TextStyle(color: PRIMARYCOLOR),),
                    ...
                    child:  Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                        ...
                        children: <Widget>[
                          ...
                          Text(' Fetching Data fom server',style: TextStyle(color: Colors.white),),
                        ],

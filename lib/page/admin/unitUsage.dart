...
class UnitUsage extends StatefulWidget{
  final Color themeColor;
  UnitUsage({this.themeColor});
  @override
  _UnitUsageState createState() => new _UnitUsageState();
}


class _UnitUsageState extends State<UnitUsage> {

  final TextEditingController _filter = new TextEditingController();
  String _searchText = "";
  Icon _searchIcon = new Icon(Icons.search);
  Widget _appBarTitle = new Text( 'PocketUnit Usage' );
  ViewModel vmodel;
  ...
  void _searchPressed() {
    setState(() {
      if (this._searchIcon.icon == Icons.search) {
        ...
        this._appBarTitle =  Text("PocketUnit Usage");
          ...
          builder: (context, model, child) => ListView.builder(
            ...
            itemBuilder: (context, index) => AwareListItem(
              ...
              child: ListItem(
                ...
                template: model.items[0] != SearchEmptyIndicatorTitle?PocketUnitUsageIndicatorTitle:SearchEmptyIndicatorTitle,
                callback: (value){
                  detail(value);
                  return value ;
                },
                ...
                children: <Widget>[
                  Expanded(
                    child: FlatButton(
                      ...
                      onPressed: (){},
                      child: Text("Transaction Reciept",style: TextStyle(color: Colors.black54),),
                    ),
                  ),
                  Expanded(
                    child: FlatButton(
                      ...
                      onPressed: (){},
                      child: Text("View Order",style: TextStyle(color: Colors.black54),),
                    ),
                  ),
                ],
              ),

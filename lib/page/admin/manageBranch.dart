...
class ManageBranch extends StatefulWidget{
  ...
  ManageBranch({this.themeColor});
  @override
  _ManageBranchState createState() => new _ManageBranchState();
}
...
class _ManageBranchState extends State<ManageBranch> {
  ...
  Widget _appBarTitle = new Text( 'Manage Branch' );
  ViewModel vmodel;
      ...
      if (this._searchIcon.icon == Icons.search) {
        ...
        this._appBarTitle =  TextFormField(
          ...
          decoration:  InputDecoration(
              ...
              hintText: 'Search by State/Province...',
              filled: true,
        ...
        this._appBarTitle =  Text(" Manage Branch");
          ...
          builder: (context, model, child) => ListView.builder(
            ...
            itemBuilder: (context, index) => AwareListItem(
              ...
              child: ListItem(
                ...
                template: model.items[0] != SearchEmptyIndicatorTitle?BranchIndicatorTitle:SearchEmptyIndicatorTitle,
                callback: (value){
                  detail(value);
                  return value ;
                },
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: FlatButton(
                      ...
                      onPressed: (){},
                      child: Text("Delete",style: TextStyle(color: Colors.black54),),
                    ),
                  ),
                ],
              ),

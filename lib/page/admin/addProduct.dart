...
class _AddProductState extends State<AddProduct> {
  ...
  void didChangeDependencies() {
    ...
    try {
      ProductDataModel(mID: psProvider
          .of(context)
          .value['user']['merchantID']).getCount().then((value) =>
          setState(() => {pCount = "Product Count: $value"})
      );
    }catch(error){}
  }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        onWillPop: () async {return Navigator.push(
            context,
            MaterialPageRoute(
                  ...
                  [
                    ...
                    psCard(
                        ...
                        child: FlatButton(
                          onPressed: () {},
                          color: PRIMARYCOLOR,
                          child: Text("Search For ${formType[btype]}",
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      ...
                                      Container(
                                          ...
                                          child: croppedFile.isNotEmpty ? Wrap(
                                              spacing: 5.0,
                                              children: List<Widget>.generate(
                                                  croppedFile.length, (index) =>
                                                  Container(
                                                    width: MediaQuery
                                                        .of(context)
                                                        .size

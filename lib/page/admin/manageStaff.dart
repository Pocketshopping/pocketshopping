...
class ManageStaff extends StatefulWidget{
  ...
  ManageStaff({this.themeColor});
  @override
  _ManageStaffState createState() => new _ManageStaffState();
}
...
class _ManageStaffState extends State<ManageStaff> {
  ...
  Widget _appBarTitle = new Text( 'Manage Staff' );
  ViewModel vmodel;
  ...
  void _searchPressed() {
    setState(() {
      if (this._searchIcon.icon == Icons.search) {
        ...
        this._appBarTitle =  Text("Manage Staff");
          ...
          builder: (context, model, child) => ListView.builder(
            ...
            itemBuilder: (context, index) => AwareListItem(
              ...
              child: ListItem(
                ...
                template: model.items[0] != SearchEmptyIndicatorTitle?StaffIndicatorTitle:SearchEmptyIndicatorTitle,
                callback: (value){
                  detail(value);
                  return value ;
                },
                ...
                children: <Widget>[
                  Expanded(
                    child: FlatButton(
                      ...
                      onPressed: (){},
                      child: Text("Edit Staff",style: TextStyle(color: Colors.black54),),
                    ),
                  ),
                  Expanded(
                    child: FlatButton(
                      ...
                      onPressed: (){},
                      child: Text("Remove Staff",style: TextStyle(color: Colors.black54),),
                    ),
                  ),
                ],
              ),

...
class _SetupBusinessState extends State<BusinessSetUpSecondPage> {
  ...
  void initState() {
    ...
    agreed = false;
    termsError =
        "You can not proceed with out accepting the terms and conditions";
                                                    ...
                                                    onPressed: () {
                                                      ...
                                                      if (_formKey.currentState
                                                                  ...
                                                                  children: <
                                                                    ...
                                                                    Column(
                                                                      children: <
                                                                          Widget>[
                                                                        Text(
                                                                            "please note this is a very important "
                                                          ...
                                                          Scaffold.of(ctx)
                                                              .showSnackBar(
                                                                  new SnackBar(
                                                                      content:
                                                                          new Text(
                                                                              "Am Working please hold on for a few sec.")));
                                                        } else {
                                                          Scaffold.of(ctx)
                                                              .showSnackBar(
                                                                  new SnackBar(
                                                                      content:
                                                                          new Text(
                                                                              "Cordinate Captured please continue with business setup")));
                                                        }
                                                      } else {
                                                        setState(() {
                                                          _autovalidate = true;
                                                        ...
                                                        Scaffold.of(ctx).showSnackBar(
                                                            new SnackBar(
                                                                content: new Text(
                                                                    "You have to fill other fields before you can start capturing cordinate")));
                                                      }
                                                    },
                                                    child: Column(
                                                      children: <Widget>[
                                                            ...
                                                            : fetching ==
                                                                ...
                                                                ? Center(
                                                                    ...
                                                                    children: <
                                                                      ...
                                                                      Text(
                                                                        "fetching Cordinate, please wait",
                                                                        style: TextStyle(
                                                                            color:
                                                                                Colors.black54),
                                                                      )
                                                                    ...
                                                                    ? Center(
                                                                        child:
                                                                          ...
                                                                          children: <
                                                                            ...
                                                                            Text(
                                                                              "fetching Complete, you can now continue",
                                              ...
                                              onPressed: () {
                                                if (_formKey.currentState
                                                  ...
                                                  if (fetching == "done") {
                                                    if (agreed) {
                                                      getDifference();
                                                      widget.data.bOpenTime =
                                                          _openingController
                                                              .text
                                                              .trim();
                                                      widget.data.bCloseTime =
                                                          _closingController
                                                              .text
                                                              .trim();
                                                      widget.data.bSocial = {};
                                                      widget.data.bStatus =
                                                          'pending';
                                                      widget.data.bCountry =
                                                          myLocale.countryCode;
                                                      widget.data.bTelephone =
                                                          ccode +
                                                      ...
                                                      if (_telephone2Controller
                                                        ...
                                                        widget.data
                                                                .bTelephone2 =
                                                            ccode2 +
                                                                (_telephone2Controller
                                                                    .text
                                                                    .trim()
                                                                    .substring(
                                                                        1));

                                                      widget.data.bGeopint =
                                                          GeoPoint(
                                                              userLocation
                                                                  .latitude,
                                                              userLocation
                                                    ...
                                                    if (fetching == 'done') {
                                                      ...
                                                      Scaffold.of(ctx).showSnackBar(
                                                          new SnackBar(
                                                              content: new Text(
                                                                  "You can not proceed without capturing cordination")));
                                                    }
                                                  }
                                                } else {
                                                  setState(() {

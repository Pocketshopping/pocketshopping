  ...
  Widget build(BuildContext context) {
      ...
      onPressed: () {
        ...
        if (_formKey.currentState.validate()) {
          ...
          if (agreed) {
            ...
            authHandler
                .signUp('user', _emailController.text.trim(),
                ...
                .then((value) => {
                      ...
                      UserData(
                              ...
                              telephone: ccode +
                                  _telephoneController.text.substring(1),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          !isNew
                              ? Text(
                                  "User already exist, head to login to access account",
      ...
      children: <Widget>[
        ...
        ClipRRect(
          ...
          child: Container(
              ...
              padding:
                  EdgeInsets.only(top: marginLR * 0.05, bottom: marginLR * 0.1),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                    ...
                    children: <Widget>[
                      Expanded(
                        ...
                        child: FlatButton(
                          ...
                          child: Text(
                            "Pocketshopping: digitalizing your pocket",
                        ...
                        child: FlatButton(
                          ...
                          child: Container(
                              padding: EdgeInsets.only(
                                  left: marginLR * 0.3, right: marginLR * 0.3),
                              child: Text(
                                'Sign In',
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: Center(
          child: Stack(
            children: <Widget>[!signup ? form : fields, showCircularProgress()],
          ),
        ),
      ),
    );

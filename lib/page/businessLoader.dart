...
class _BusinesSetupLoaderState extends State<BusinesSetupLoader> {
  ...
  void initState() {
    ...
    super.initState();
    widget.data.bCroppedPhoto != null?_startUpload():photolessRegistration();
  ...
  void _startUpload() {
    ...
    setState(() {
      ...
      _uploadTask = _storage.ref().child(filePath).putFile(widget.data.bCroppedPhoto);
    });
  }
    ...
    StreamBuilder<StorageTaskEvent>(
          ...
          builder: (_, snapshot) {
            ...
            if(progressPercent == 1){
              ...
              job='Setting up business account please wait.';
              snapshot.data.snapshot.ref.getDownloadURL().then((value) =>
              {
                    ...
                    child: Center(
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(job,style: TextStyle(fontSize: 16,color: Colors.black54),),
                          ],
                        )

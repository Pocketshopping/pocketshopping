...
class _LocationUIState extends State<LocationUI>{
  ...
  Widget _appBarTitle = new Text("PocketShopping",style: TextStyle(color: PRIMARYCOLOR), );
  ViewModel vmodel;
  String barcode = "";
  int _value=0;
  int loader=0;
  ...
  void _searchPressed() {
    setState(() {
      if (this._searchIcon.icon == Icons.search) {
        ...
        this._appBarTitle =  Text("PocketShopping",style: TextStyle(color: widget.themeColor),);
            ...
            SliverGrid(
              ...
              delegate: new SliverChildBuilderDelegate(
                  ...
                  return SinglePlaceWidget(
                      ...
                      mData:{'title':'Amala Place'+index.toString(),'cover':covers[index%loader]});
                },
                childCount: loader,
              ),
            ),

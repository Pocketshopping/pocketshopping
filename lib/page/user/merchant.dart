...
class _MerchantWidget extends State<MerchantWidget> {
  ...
  _updatePalettes() async {
    ...
    color = generator.paletteColors.isNotEmpty
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextField(
                            decoration: InputDecoration(
                              ...
                              hintText: widget.data['title'] != null
                                  ? "Search " + widget.data['title']
                                  : 'Search This Merchant',
                            ),
                          ),
                        ),
                        IconButton(
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            ...
                            showBottomSheet(
                                context: context,
                                builder: (context) => BottomSheetMapTemplate());
                          },
                        ),
                      ],
                    ),
                    ...
                    SliverGrid(
                      ...
                      delegate: new SliverChildBuilderDelegate(
                        (BuildContext context, int index) {
                          return ProductWidget(PRIMARYCOLOR);
                        },
                        childCount: loadmore,
                      ),
                    ),
      ...
      floatingActionButton: Builder(
          builder: (context) => FloatingActionButton(
                onPressed: () {
                  showBottomSheet(
                      context: context,
                      builder: (context) => BottomSheetCartWidget());
                },

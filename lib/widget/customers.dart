...
class _CustomerState extends State<Customer> {
  ...
  void initState() {
    ...
    super.initState();
    currentTab=0;
    tab1=NewCustomer(tab: currentTab,);
...
class NewCustomer extends StatelessWidget {
  ...
  final String search;
  final int tab;
  NewCustomer({Key key,this.themeColor,this.search,this.tab}) : super(key: key);
          ...
          builder: (context, model, child) => ListView.builder(
            ...
            itemBuilder: (context, index) => AwareListItem(
              ...
              child: ListItem(
                ...
                template: model.items[0] !=SearchEmptyIndicatorTitle?NewCustomerIndicatorTitle:SearchEmptyIndicatorTitle,
                callback: (value){
                  detail(value);
                  return value ;
                },
      ...
      showModalBottomSheet(
        ...
        builder: (context) =>
            BottomSheetTemplate(
              height: MediaQuery.of(context).size.height*0.6,
              opacity: 0.2,
              child: showRecurringDetail(name: name,),
            ),
        isScrollControlled: true,
      );
    }
        ...
        child: Consumer<ViewModel>(
          ...
          builder: (context, model, child) => ListView.builder(
            ...
            itemBuilder: (context, index) => AwareListItem(
              ...
              child: ListItem(
                title: model.items[index],
                template: model.items[0] !=SearchEmptyIndicatorTitle?OldCustomerIndicatorTitle:SearchEmptyIndicatorTitle,
                callback: (value){
                  detail(value);
                  return value ;
                },
...
class showDetail extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return  Container(
      ...
      child:  Column(
        children: <Widget>[
          Align(alignment:Alignment.center,child: Center(child: Text('New Customer ',style: TextStyle(fontSize: 18),),),),
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Text("Amount Spent",style: TextStyle(color:Colors.black54),),
            ],
          ),
          Container(height: marginLR*0.01,),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,

            children: <Widget>[
              Text("AttendedToBy",style: TextStyle(color:Colors.black54),),
            ],
          ),
          ...
          Align(
            ...
            FlatButton(
              ...
              ,),),
          Container(height: marginLR*0.03,),
          Align(alignment:Alignment.center,child: Center(child: Text('Customer Experience',style: TextStyle(fontSize: 18),),),),
          Container(height: marginLR*0.03,),
          RatingBar(
            onRatingUpdate: (rate){},
            initialRating: 3.5,
          ...
          Column(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text("i enjoyed the meal but i would advise you work more on your customer care service thank you",style: TextStyle(color:Colors.black54),),
            ],
          ),
          Container(height: marginLR*0.03,),
          Align(alignment:Alignment.center,child: Center(child: Text('Order(s) Made',style: TextStyle(fontSize: 18),),),),
          Container(height: marginLR*0.03,),
          Column(
            children: <Widget>[
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Text("OrderID",style: TextStyle(color:Colors.black54),),
                    FlatButton(
                      onPressed: (){},

          ...
          builder: (context, model, child) => ListView.builder(
            ...
            itemBuilder: (context, index) => AwareListItem(
              ...
              child: ListItem(
                ...
                template: model.items[0] !=SearchEmptyIndicatorTitle?ReviewsIndicatorTitle:SearchEmptyIndicatorTitle,
                callback: (value){
                  detail(value);
                  return value ;
                },
...
class showDetail extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    ...
    return  Container(
      ...
      child:  Column(
        children: <Widget>[
          Align(alignment:Alignment.center,child: Center(child: Text('Old Customer ',style: TextStyle(fontSize: 18),),),),
          ...
          Column(
            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  Expanded(child:Text("number of time this customer Visited",style: TextStyle(color:Colors.black54,),),
                  ),
                  Expanded(child:Text("0",style: TextStyle(color:Colors.black54),)
                  ),
                ],
              ),
              Container(
              ...
              Row(
                children: <Widget>[
                  Expanded(child:Text("Amount Generated from this customer",style: TextStyle(color:Colors.black54),),
                  ),
                  Expanded(child:Text("23",style: TextStyle(color:Colors.black54),),
                  )
          ...
          Column(
            ...
            children: <Widget>[
              ...
              FlatButton(
                ...
                child: Text("View all Reviews for this customer",style: TextStyle(color: Colors.black54),),
              )
            ],
          ),
          Container(height: marginLR*0.03,),

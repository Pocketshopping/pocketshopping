...
class PocketTransfer extends StatefulWidget {
  final String wallet;
  final Function callBackAction;
  final User user;
  PocketTransfer({this.wallet,this.callBackAction,this.user});
  @override
  _PocketTransferState createState() => new _PocketTransferState();
}

class _PocketTransferState extends State<PocketTransfer> {
                                  ...
                                  child: Row(
                                    children: [
                                      Expanded(
                                          ...
                                          child: Container(child: Padding(padding: EdgeInsets.symmetric(horizontal: 10),child: Text('Fund Transfer'),))
                                      ),
                                      Expanded(
                                        flex: 0,
                                        child: IconButton(
                                    ...
                                    children: [
                                      Expanded(
                                          ...
                                          child: Container(child: Padding(padding: EdgeInsets.symmetric(horizontal: 10),
                                            child: Text('Balance: $CURRENCY${wallet.data.walletBalance}',
                                        ...
                                        child: TextFormField(
                                          validator: (value) {
                                            ...
                                            if(int.tryParse(value) < 100){
                                              return 'Must be greater than ${CURRENCY}100';
                                            }
                                            if((int.tryParse(value)+2) > wallet.data.walletBalance){
                                              return 'Insufficient fund for transfer (Convenience Fee included)';
                                            }
                                              ...
                                              Get.defaultDialog(
                                                ...
                                                content: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Align(alignment: Alignment.centerLeft,child: Text('Amount: $CURRENCY${amount.text}'),),
                                                    Align(alignment: Alignment.centerLeft,child: Text('Recipient: ${recipient.value.fname}'),),
                                                    Align(alignment: Alignment.centerLeft,child: Text('Convenience Fee: ${CURRENCY}2.0'),),
                                                  ],
                                                ),
                                                cancel: FlatButton(
                                                  onPressed: (){Get.back();},
                                                  ...
                                                  onPressed: ()async{
                                                    ...
                                                    if(set){
                                                      ...
                                                      Get.dialog(PinTester(wallet: widget.wallet,callBackAction: ()async{
                                                        Utility.bottomProgressLoader(title: 'Pocket Transfer',body: 'Transferring $CURRENCY${amount.text}...please wait');
                                                        bool result = await Utility.walletTransfer(
                                                        ...
                                                        if(result != null){
                                                          if(result){
                                                            Utility.bottomProgressSuccess(title: 'Pocket Transfer',body: 'Transfer complete',wallet: widget.wallet);
                                                            Utility.pushNotifier(fcm:recipient.value.notificationID,
                                                                body:"$CURRENCY${amount.text} was transferred to you by ${widget.user.fname}",
                                                                title:'Fund Transfer',
                                                                notificationType:"PocketTransferResponse",
                                                            data: {'wallet':recipient.value.walletId});
                                                          }
                                                          else{
                                                            Utility.bottomProgressFailure(title: 'Pocket Transfer',body: 'Error transferring fund...check connection and Try again');
                                                          }
                                                        }
                                                        else{
                                                          Utility.bottomProgressFailure(title: 'Pocket Transfer',body: 'Error transferring fund...check connection and Try again');

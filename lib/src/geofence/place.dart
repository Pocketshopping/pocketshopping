...
class _SinglePlaceWidgetUIState extends State<SinglePlaceWidget> {
  ...
  place ()async{
    List<Placemark> placemark = await Geolocator()
        .placemarkFromCoordinates(widget.cPosition.geoPoint.latitude,
  ...
  address()async{
    final coordinates = new geocode.Coordinates(widget.cPosition.geoPoint.latitude,
        widget.cPosition.geoPoint.longitude);
  ...
  @override
    ...
    double dist =  widget.cPosition.distance(lat: widget.merchant.bGeoPoint['geopoint'].latitude,
          ...
          Container(
            ...
            Column(
              children: <Widget>[
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Expanded(
                        flex: 3,
                        child: Center(child:
                        Text(widget.merchant.bCategory, style: TextStyle(fontSize: 12,
                            color: Colors.white),
                          textAlign: TextAlign.left
                          ,)),
                      ),
                      Expanded(
                        child: widget.cPosition != null ? IconButton(
                ...
                Column(
                  children: <Widget>[
                    Text(widget.merchant.bName, style: TextStyle(
                    ...
                    if(dist > 0.1)
                      Row(
                        ...
                        children: <Widget>[
                          widget.merchant.bDelivery == 'No' ? Icon(
                            Icons.close, color: Colors.red,) : Icon(

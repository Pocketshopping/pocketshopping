                        ...
                        Container(
                          ...
                          child: Center(
                            ...
                            children: <Widget>[
                              ...
                              Center(
                                  child: Text(
                                "Note. Adding more product will increase your visibility"
                                "",
                                style: TextStyle(
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: state.barCode.isNotEmpty
                                            ? Text(
                                                'Product Code: ${state.barCode}')
                                            : Container(),
                                      )
                                    ],
                                  ),
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      ...
                                      Container(
                                          padding: EdgeInsets.only(top: 10),
                                          child: state.croppedImage.isNotEmpty
                                              ? Wrap(
                                                  spacing: 5.0,
                                                  children:
                                                                    ...
                                                                    Align(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          setState(
                                                                              () {
                                                                            state.croppedImage.remove(state.croppedImage[index]);
                                                                          });
                                                                        },
                                                                        alignment:

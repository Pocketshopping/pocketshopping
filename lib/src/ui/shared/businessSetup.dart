...
class BSetup extends StatelessWidget{
  ...
  BSetup({Key key, @required UserRepository userRepository,})
    ...
    child:Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Would you like to setup a business?',style: TextStyle(fontSize: 18),),
            ),
            Padding(
              ...
              child: RaisedButton(
                ...
                child: Container(
                  width: MediaQuery.of(context).size.width*0.9,
                  child: Center(
                    child: Text('Yes, I want to',style: TextStyle(color: Colors.white),),
                  ),
                ),
              )

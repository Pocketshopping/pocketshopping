...
class Channels {
  ...
  Channels({this.oChannels, this.mChannels, this.dChannels, this.cChannels});
  ...
  static Map<String, dynamic> toUpdate(
      DocumentSnapshot snap, String uid, String newToken) {
    ...
    if (shouldUpdateOrdering) toUpdate['Ordering'] = Ordering;
    if (shouldUpdateMessaging) toUpdate['Messaging'] = Messaging;
    if (shouldUpdateDelivery) toUpdate['Delivery&Pickup'] = Delivery;
    if (shouldUpdateCashier) toUpdate['Cashier'] = Cashier;

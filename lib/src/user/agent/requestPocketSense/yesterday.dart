...
class YesterdayMisses extends StatefulWidget {
  final Session user;
  YesterdayMisses({this.user});
  @override
  _YesterdayMissesState createState() => new _YesterdayMissesState();
}

class _YesterdayMissesState extends State<YesterdayMisses> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        builder: (_, LocationData currentLoc,__){
          if(currentLoc != null)
          {
            StatisticRepo.getMissedDeliveryRequest(geoLoc.Position(latitude: currentLoc.latitude,longitude:currentLoc.longitude ),"Y").then((value) { if(mounted)_latLngNotifier.value=value;});

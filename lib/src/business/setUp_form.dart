...
class _BusinessSetupFormState extends State<BusinessSetupForm> {
  ...
  bool get isPopulated => _addressController.text.isNotEmpty && _nameController.text.isNotEmpty
                          ...
                          children: <Widget>[
                              ...
                              Column(
                                children: <Widget>[
                                  ...
                                  DropdownButtonFormField<String>(
                                    ...
                                    items:['Restuarant', 'Store', 'Super Market','Bar','Park']
                                    ...
                                    onChanged: (value) {
                                      _businessBloc.add(CategoryChanged(category: value));
                                    },
                            ...
                            Container(
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                items:['No', 'Yes, I have my own delivery service', 'Yes, Use pocketshooping logistic(only in Abuja and lagos)']
                                    .map((label) => DropdownMenuItem(
                                  child: Text(label,style: TextStyle(color: Colors.black54),),
                                  value: label,
                                ))
                                ...
                                onChanged: (value) {
                                  _businessBloc.add(DeliveryChanged(delivery: value));
                                },
                            ...
                            Container(
                              ...
                              child:  Column(
                                ...
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: <Widget>[
                                  Center(child: Text("Capture Business Premise Cordinate",
                                  style: TextStyle(color: Colors.black54),),),
                                  state.isCapturing == "NO" || state.isCapturing == "FAIL"?
                                  Column(
                                    children: <Widget>[
                                  FlatButton(
                                    ...
                                    child: Center(
                                      ...
                                      Center(child: Text("Click the button above to start capturing",
                                          style: TextStyle(color: Colors.black54)),),
                                    ]):state.isCapturing == "YES"?
                                  Column(
                                    children: <Widget>[
                                      Image.asset('assets/images/place.gif',
                                        //color: PRIMARYCOLOR,
                                        width: MediaQuery.of(context).size.width*0.4,
                                        height:MediaQuery.of(context).size.height*0.2,
                                        fit: BoxFit.cover,
                                      ),
                                      Center(child: Text("Capturing Please wait...$_start",
                                          style: TextStyle(color: Colors.black54)),),
                                    ],
                                  )
                                  ...
                                  Center(
                                      ...
                                      Center(child: Text("Cordinate successfully captured",
                                          style: TextStyle(color: Colors.black54)),),
                                  ]
                                  )
                                      :Container(),
                            ...
                            Container(
                              ...
                              child:!state.isSuccess? Padding(
                                ...
                                child: FlatButton(
                                  ...
                                  color: PRIMARYCOLOR,
                                  child: Center(child:Text('Go to Dashboard',style: TextStyle(color: Colors.white),)),
                                ),
                              ),
                            ),

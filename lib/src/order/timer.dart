              ...
              children: <Widget>[
                Container(
                    ...
                    child: CircularStepProgressIndicator(
                      ...
                      selectedStepSize: 15,
                      child: Center(
                        child: widget.message.isNotEmpty?Text('$counter ${widget.message}',textAlign: TextAlign.center,):Container(),
                      ),
                    ),

                ),
                Center(
                    child: Text('Confirming order from merchant',style: TextStyle(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Center(
              child: Text('Sorry we can not process this order because the merchant'
                  ' is unavailable',style: TextStyle(
                  fontSize: MediaQuery.of(context).size.height*0.03
              ),
                textAlign: TextAlign.center,
              ),

...
class RiderErrandDirection extends StatefulWidget {
  RiderErrandDirection(
  ...
  @override
  State<StatefulWidget> createState() => _RiderErrandDirectionState();
}

class _RiderErrandDirectionState extends State<RiderErrandDirection> {
                ...
                children: [
                  if(path != null)
                    if(!path.hasVisitedSource && !path.hasVisitedDestination)
                      Center(
                        child:
                        Text('Rider is coming to get package from you',
                  ...
                  if(path != null)
                    if(path.hasVisitedSource && !path.hasVisitedDestination )
                      Center(
                          child:
                          Text('Rider is taking package to Destination',
                            style: TextStyle(color: Colors.black54,fontSize: 18,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                  ...
                  if(path != null)
                    if(path.hasVisitedSource && path.hasVisitedDestination )
                      Center(
                          child:
                          Text('Rider is few meters to the destination. Inform The Reciever',
                      ...
                      children: [
                        Center(
                            ...
                            Padding(
                              ...
                              child: Text('Rider is currently coming to collect the package from you, Ensure the rider accepts the errand task before handing over the package.',
                    ...
                    Column(
                      children: [
                        Center(
                            ...
                            Padding(
                              padding: EdgeInsets.symmetric(horizontal: 10),
                              child: Text('Rider is taking package to the destination. Give the confirmation code to the reciever for errand comfirmation',
                                style: TextStyle(color: Colors.black54,fontSize: 18),textAlign: TextAlign.center,),
                            )

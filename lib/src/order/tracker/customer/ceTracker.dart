...
class CustomerErrandTrackerWidget extends StatefulWidget {
  CustomerErrandTrackerWidget({this.order, this.user,this.isActive=false});
  ...
  @override
  State<StatefulWidget> createState() => _CustomerErrandTrackerWidgetState();
}

class _CustomerErrandTrackerWidgetState extends State<CustomerErrandTrackerWidget> {
